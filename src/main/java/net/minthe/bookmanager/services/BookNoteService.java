...
public class BookNoteService {
  ...
  @PreAuthorize("@authService.canActForUser(#request.username) || #request.username == null")
  public BookNote createBookNote(CreateBookNoteRequest request) {
    ...
    bookNote.setUsername(request.getUsername() != null
        ? request.getUsername() : authService.getUsername());
